...
from src.dgp_with_init.outer_layer import SingleGP, SingleCauchyGP, SingleLaplacianGP, SingleGPFix,SingleGPNoBias
...
class DeepGP(PyroModule):
    ...
    def __init__(
        ...
        for i in range(len(in_dim_list)):
            params = {}
            if f'init_1st_w{i}' in kwargs:
                params['init_1st_w'] = kwargs[f'init_1st_w{i}']
            if f'init_1st_b{i}' in kwargs:
                params['init_1st_b'] = kwargs[f'init_1st_b{i}']
            if f'init_2nd_w{i}' in kwargs:
                params['init_2nd_w'] = kwargs[f'init_2nd_w{i}']
            if f'init_2nd_b{i}' in kwargs:
                params['init_2nd_b'] = kwargs[f'init_2nd_b{i}']

            layer_list.append(SingleGP(in_dim_list[i],out_dim_list[i], J_list[i], **params))
