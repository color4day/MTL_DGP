...
class FirstLayertest(PyroModule):
    r"""
    ...
    def __init__(
        ...
        super().__init__()
        self.J = hid_dim // 2
        init_w_mean = kwargs.get("init_w_mean", torch.zeros(self.J, in_dim)).cuda()
        init_w_var = kwargs.get("init_w_var", torch.ones(self.J, in_dim)).cuda()
        init_b_mean = kwargs.get("init_b_mean", torch.zeros(self.J, in_dim)).cuda()
        init_b_var = kwargs.get("init_b_var", torch.ones(self.J, in_dim)).cuda()
        ...
        self.layer.weight = PyroSample(dist.Normal(init_w_mean, init_w_var))#PyroSample(dist.Normal(0., 1.0).expand([self.J, in_dim]).to_event(2))
...
class SecondLayertest(PyroModule):
    ...
    def __init__(
        ...
        """
        super().__init__()
        init_w_mean = kwargs.get("init_w_mean", torch.zeros(out_dim, hid_dim)).cuda()
        init_w_var = kwargs.get("init_w_var", torch.ones(out_dim, hid_dim)).cuda()
        # init_b_mean = kwargs.get("init_b_mean", torch.zeros(out_dim, hid_dim)).cuda()
        # init_b_var = kwargs.get("init_b_var", torch.ones(out_dim, hid_dim)).cuda()
